...
CLAUDE_DEFAULT_HAIKU_MODEL_NAME_ENV_KEY = "ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME"
CLAUDE_DEFAULT_OPUS_MODEL_ENV_KEY = "ANTHROPIC_DEFAULT_OPUS_MODEL"
CLAUDE_DEFAULT_OPUS_MODEL_NAME_ENV_KEY = "ANTHROPIC_DEFAULT_OPUS_MODEL_NAME"
CLAUDE_DEFAULT_SONNET_MODEL_ENV_KEY = "ANTHROPIC_DEFAULT_SONNET_MODEL"
CLAUDE_DEFAULT_SONNET_MODEL_NAME_ENV_KEY = "ANTHROPIC_DEFAULT_SONNET_MODEL_NAME"
...
def claude_env_from_profile(profile: Profile) -> dict[str, str]:
    model = profile.claude_display_model
    return {
        ...
        CLAUDE_DEFAULT_HAIKU_MODEL_NAME_ENV_KEY: model,
        CLAUDE_DEFAULT_OPUS_MODEL_ENV_KEY: model,
        CLAUDE_DEFAULT_OPUS_MODEL_NAME_ENV_KEY: model,
        CLAUDE_DEFAULT_SONNET_MODEL_ENV_KEY: model,
        CLAUDE_DEFAULT_SONNET_MODEL_NAME_ENV_KEY: model,
    }
